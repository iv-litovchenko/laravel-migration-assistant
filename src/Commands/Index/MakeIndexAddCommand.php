...
final class MakeIndexAddCommand extends AbstractMakeCommand
{
    protected $signature = 'make:massist:index:index.add';
    protected $stubPath = 'index/index.add.stub';
    protected $fileNamePrefix = 'field_index_add_';
