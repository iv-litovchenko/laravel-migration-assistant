...
final class MakeIndexUniqueDropCommand extends AbstractMakeCommand
{
    protected $signature = 'make:massist:index:unique.drop';
    protected $stubPath = 'index/unique.drop.stub';
    protected $fileNamePrefix = 'field_index_unique_drop_';
